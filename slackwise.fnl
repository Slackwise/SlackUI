(global MOUNTS_BY_USAGE
        {:DEFAULT {:FLYING (. MOUNT_IDS "Ashes of Al'ar")
         ...
         :HUNTER {:FLYING (. MOUNT_IDS "Ashes of Al'ar")
                  ...
                  :GROUND_SHOWOFF (. MOUNT_IDS "Swift Razzashi Raptor")
                  :WATER (. MOUNT_IDS "Sea Turtle")}
         :MAGE {:FLYING (. MOUNT_IDS "Celestial Steed")
                ...
                :GROUND_SHOWOFF (. MOUNT_IDS "Swift Razzashi Raptor")
                :WATER (. MOUNT_IDS "Sea Turtle")}
         :PALADIN {:FLYING (. MOUNT_IDS "Chaos-Forged Gryphon")
                   :FLYING_PASSENGER (. MOUNT_IDS "Algarian Stormrider")
                   :FLYING_SHOWOFF (. MOUNT_IDS "Swift Razzashi Raptor")
                   ...
                   :GROUND_SHOWOFF (. MOUNT_IDS "Swift Razzashi Raptor")
                   :WATER (. MOUNT_IDS "Sea Turtle")}
         :PRIEST {:FLYING (. MOUNT_IDS "Ashes of Al'ar")
                  ...
                  :GROUND_SHOWOFF (. MOUNT_IDS "Swift Razzashi Raptor")
                  :WATER (. MOUNT_IDS "Sea Turtle")}
         :SHAMAN {:FLYING (. MOUNT_IDS "Ashes of Al'ar")
                  :FLYING_PASSENGER (. MOUNT_IDS "Algarian Stormrider")
                  :FLYING_SHOWOFF (. MOUNT_IDS "Swift Razzashi Raptor")
                  :GROUND (. MOUNT_IDS "Swift Razzashi Raptor")
                  :GROUND_PASSENGER (. MOUNT_IDS "Algarian Stormrider")
                  ...
                  :WATER (. MOUNT_IDS "Sea Turtle")}})
(global BINDINGS
        {:CLASSIC {:DRUID [[:1 :command :ACTIONBUTTON1]
                   ...
                   :PALADIN [[:1 :command :ACTIONBUTTON1]
                             [:2 :command :ACTIONBUTTON2]
                             [:3 :command :ACTIONBUTTON3]
                             [:4 :command :ACTIONBUTTON4]
                             [:5 :command :ACTIONBUTTON5]
                             ...
                             [:ALT-Z :item "Insignia of the Alliance"]]
                   :PRIEST [[:1 :command :ACTIONBUTTON1]
                            [:2 :command :ACTIONBUTTON2]
                            [:3 :command :ACTIONBUTTON3]
                            [:4 :command :ACTIONBUTTON4]
                            [:5 :command :ACTIONBUTTON5]
                            ...
                            [:CTRL-Z :spell :Fade]
                            [:V :macro :SHIELD_SELF]]}
         :GLOBAL [[:ALT-CTRL-END :command :SLACKWISETWEAKS_RELOADUI]
                  ...
                  [:SHIFT-H :command :TOGGLECHARACTER4]
                  [:CTRL-H :macro :HEARTH]
         ...
         :RETAIL {:DRUID {:BALANCE [[:CTRL-3 :spell :Starfall]
                                    [:5 :spell "Fury of Elune"]
                                    [:SHIFT-5 :spell "Wild Mushroom"]
                                    [:X :macro :X]
                                    [:G :spell "Celestial Alignment"]
                                    [:SHIFT-G :spell "Celestial Alignment"]]
                          :CLASS [[:BUTTON4 :macro :MOUSE4]
                                  [:SHIFT-SPACE :macro :TRAVEL]
                                  [:CTRL-SPACE :spell "Wild Charge"]
                                  [:CTRL-SHIFT-SPACE
                                   :command
                                   :SLACKWISETWEAKS_MOUNT]
                  ...
                  :HUNTER {:CLASS [[:F8 :spell "Call Pet 1"]
                                   [:F9 :spell "Call Pet 2"]
                                   ...
                                   [:4 :spell "Arcane Shot"]
                                   [:Q :macro :PetControl]
                                   [:CTRL-Q :command :BONUSACTIONBUTTON7]
                                   [:CTRL-SHIFT-Q :command :BONUSACTIONBUTTON1]
                           ...
                           :MARKSMANSHIP [[:SHIFT-2 :spell "Aimed Shot"]
                                          ...
                                          [:G :macro :Trueshot!]]
                           :SURVIVAL [[:1 :macro "Serpent Sting"]
                  ...
                  :MAGE {:ARCANE {}
                         ...
                         :FIRE {}
                         :FROST [[:BUTTON4 :macro :BLIZZ_CURSOR]
                                 [:3 :spell "Comet Storm"]
                                 [:4 :spell "Ice Lance"]
                                 [:5 :spell :Flurry]
                                 [:Q :spell "Frozen Orb"]
                                 [:V :spell "Ice Barrier"]]}
                  :PALADIN {:CLASS [[:1 :command :ACTIONBUTTON1]
                                    [:2 :command :ACTIONBUTTON2]
                                    [:3 :command :ACTIONBUTTON3]
                                    [:4 :command :ACTIONBUTTON4]
                                    [:5 :command :ACTIONBUTTON5]
                            ...
                            :PROTECTION [[:SHIFT-1 :spell "Cleanse Toxins"]
                            ...
                            :RETRIBUTION [[:SHIFT-1 :spell "Cleanse Toxins"]
                  ...
                  :PRIEST {:CLASS [[:1 :spell :Renew]
                                   ...
                                   [:BUTTON4 :macro :MOUSE4]]
                           :DISCIPLINE {}
                           :HOLY [[:1 :spell "Holy Word: Serenity"]
                                  [:SHIFT-1 :spell :Renew]
                                  [:SHIFT-2 :spell :Heal]
                           ...
                           :SHADOW {}}
                  :SHAMAN {:CLASS [[:1 :spell "Flame Shock"]
                           ...
                           :ELEMENTAL [[:BUTTON4 :macro :MOUSE4_ELE]]
                           :ENHANCEMENT {}
                           :RESTORATION [[:BUTTON4 :macro :MOUSE4_RESTO]
                                         [:1 :spell :Riptide]
                  ...
                  :WARRIOR {:ARMS {}
                            :CLASS [["`" :spell ""]
                                    ...
                                    [:BUTTON4 :macro :MOUSE4]]
                            :FURY {}
                            :PROTECTION [[:V :spell "Shield Wall"]]}}})	